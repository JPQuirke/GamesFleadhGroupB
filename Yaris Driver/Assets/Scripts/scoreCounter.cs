...
public class scoreCounter : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       //if the score is above 20 spawner changes to spawner 2
        if (scoreTotal > 20.0f){
            spawner1.SetActive(false);
            spawner2.SetActive(true);
        }
        //if the score is above 60 spawner changes to spawner 3
         if (scoreTotal > 60.0f){
            spawner2.SetActive(false);
            spawner3.SetActive(true);
        }
        //if the score is above 100 spawner changes to spawner 4
          if (scoreTotal > 100.0f){
            spawner3.SetActive(false);
            spawner4.SetActive(true);
        }
        //if the score is above 140 spawner changes to spawner 5
         if (scoreTotal > 140.0f){
            spawner4.SetActive(false);
            spawner5.SetActive(true);     
         }
         //if the score is above 180 spawner changes to spawner 6
